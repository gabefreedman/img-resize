...
class ImageApp:
    ...
    def __init__(self):
        ...
        self.folderLabel = tk.Label(
            self.root, text="Choose folder with images to resize:"
        )
        ...
        self.heightLabel = tk.Label(
            self.root, text="Enter desired image height in inches:"
        )
        ...
        self.identLabel = tk.Label(
            self.root, text="Identifier to add to new folder name:"
        )
        ...
        self.borderCheck = tk.Checkbutton(
            self.root, text="Add border? (1px)", variable=self.borderVar
        )
        self.borderCheck.grid(column=1, row=3, sticky="EW", padx=4, pady=4)

        self.bigButton = tk.Button(
            self.root, text="Resize", command=self.gather_resize_params
        )
